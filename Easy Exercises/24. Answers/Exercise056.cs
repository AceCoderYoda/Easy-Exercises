...
public class Exercise056
{
    ...
    {
        int yr, mn, dt;
        Console.Write("\n\n Find the first day of the next month against a given date :\n");
        Console.Write("----------------------------------------------------------------\n");
        ...
        Console.WriteLine(" The first day of the next month for the above date is : {0}\n", FirstDayOfNextMonth(d).ToString("dd/MM/yyyy"));
    }
